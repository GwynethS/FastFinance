        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="/public/assets/images/isotipoVB.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="/public/assets/images/logo_BV.png" alt="" height="22">
                    </span>
                </a>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0"
                                        key="t-ui-components"><?= lang('Files.UI Components') ?></h5>
                                ...
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0"
                                        key="t-applications"><?= lang('Files.Applications') ?></h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);"
                                ...
                                <div class="col-md-4">
                                    <h5 class="font-size-14 mt-0"
                                        key="t-extra-pages"><?= lang('Files.Extra Pages') ?></h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);"
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="/public/assets/images/megamenu-img.png" alt=""
        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php if ($lang !== 'de'): ?>
                        <a href="<?= base_url('lang/de'); ?>" class="dropdown-item notify-item language" data-lang="gr">
                            <img src="/public/assets/images/flags/germany.jpg" alt="user-image" class="me-1"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <!--<img class="rounded-circle header-profile-user d-xl-none" src="/public/assets/images/users/avatar-1.jpg"
                        alt="Header Avatar">-->
                    <i class="bx bx-user-circle rounded-circle d-xl-none" style="font-size: 30px"></i>
                    <span class="d-none d-xl-inline-block ms-1"
                          key="t-henry"><?php echo $session->get('name') . ' ' . $session->get('lastname') ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="/public/user-change-password"><i
                                class="bx bx-lock font-size-16 align-baseline me-1"></i> <span
                                key="t-profile">Cambiar contraseña</span></a>
                    <a class="dropdown-item d-none" href="#"><i class="bx bx-wallet font-size-16 align-middle me-1"></i>
                        <span key="t-my-wallet">My Wallet</span></a>
                    <a class="dropdown-item d-none" href="#"><span class="badge bg-success float-end">11</span><i
                                class="bx bx-wrench font-size-16 align-middle me-1"></i> <span
                                key="t-settings">Settings</span></a>
                    <a class="dropdown-item d-none" href="auth-lock-screen"><i
                                class="bx bx-lock-open font-size-16 align-middle me-1"></i> <span key="t-lock-screen">Lock screen</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="/public/auth-logout"><i
        ...
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <!-- SOLO ROL ADMIN Y SUPERADMIN -->
                    <?php
                    if ($session->get('role')['alias'] == 'admin' || $session->get('role')['alias'] == 'superadmin') { ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" role="button">
                                <i class="bx bx-user"></i> <span>Gestión de colaboradores</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                <a href="/public/user-list" class="dropdown-item">Empleados</a>
                            </div>
                        </li>
                    <?php } ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" role="button">
                            <i class="bx bx-gift"></i> <span>Mis beneficios</span>
                            <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                            <a href="/public/benefit-coupon" class="dropdown-item">Cuponera</a>
                            <a href="/public/benefit-corporate" class="dropdown-item">Corporativo</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" role="button">
                            <i class="bx bx-file"></i> <span>Políticas</span>
                            <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                            <a href="/public/policy-list" class="dropdown-item">Políticas Corporativas GLM</a>
                        </div>
                    </li>
                    <?php if ($session->get('role')['alias'] == 'admin' || $session->get('role')['alias'] == 'superadmin') { ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" role="button">
                                <i class="bx bx-image-add"></i> <span>Publicaciones</span>
                                <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                <a href="/public/post-create" class="dropdown-item">Crear publicación</a>
                            </div>
                        </li>
                    <?php } ?>
                </ul>
