    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title d-none" key="t-apps"><?= lang('Files.Apps') ?></li>
                ...
                <li class="menu-title d-none" key="t-pages"><?= lang('Files.Pages') ?></li>
                ...
                <li class="menu-title d-none" key="t-components"><?= lang('Files.Components') ?></li>
