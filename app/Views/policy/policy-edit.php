            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Editar política</h4>
                                <form method="post"
                                      action="/public/policy-edit/<?php echo $policy['id'] ?>"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea name="description" type="text" class="form-control"
                                                      ...
                                                      style="resize: none;"><?php echo $policy['description'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <?php if ($policy['file']) { ?>
                                                <br>
                                                <a href="/public/<?php echo $policy['file']; ?>"
                                                   target="_blank">
                                                    <i class="bx bx-download"></i> <?php $nameFile = explode('/', $policy['file']);
                                                    echo $nameFile[count($nameFile) - 1] ?>
                                                </a>
                                            <?php } ?>
                                        </div>
                                    </div>
