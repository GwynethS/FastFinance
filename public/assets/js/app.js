...
(function ($) {
    ...
    function addRow(idTable){
        $('#'+idTable+' tbody').append('<tr>'+$('#'+idTable+' tbody').find('tr').last().html()+'</tr>');
        $('#'+idTable+' tbody').find('tr').last().find('select').val('');
        $('#'+idTable+' tbody').find('tr').last().find('input').val('');
    }
    ...
    $('.datatable').DataTable({
        ...
        "language": {
            ...
            "infoFiltered": "(Filtrado de MAX en total)",
            "infoPostFix": "",
